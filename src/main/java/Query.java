...
public class Query implements IQuery {
    ...
    public void executeSQL05() {
        ...
        String sqlStatement = "SELECT SUM(numberOfRegisteredChildren) FROM data " +
                "WHERE ticketType = 'Y' " +
                "AND source IN (1,2,3,20,30) " +
    ...
    public void executeSQL06() {
        ...
        String sqlStatement = "SELECT AVG(numberOfRegisteredChildren) FROM data " +
                "WHERE ticketType = 'Y' " +
                "AND source IN (1,2,3,20,30) " +
                "AND destination NOT IN (5,10,15,20) " +
                "AND isOffPeak = 'false'";
        queryDump(sqlStatement);
    }
